...
## Project Structure
    ...
    ├── testapiautosetting_128024  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_128024`
...
2. Clone this repo and `cd testapiautosetting_128024`
